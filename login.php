...
<div class='login login-itlu-ui'>
	<div id="login">
		<h1><a href="https://acs.yhy123.top/" title="记账管理系统-温馨杂货站" tabindex="-1">记账管理系统-温馨杂货站</a></h1>
		...
		<?php }else{?>
		<p id="nav"><a href="?action=getpassword">忘记密码？</a><?php if(Multiuser=="1"){?> | <a href="?action=register">没有账号？联系QQ：463320452</a><?php }?></p>
		<?php }?>
	</div>
